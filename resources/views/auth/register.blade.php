        ...
        <div class="col-lg-6 col-md-12 mt-6 mt-lg-0">
          <div class="login-form white-bg p-5 rounded box-shadow">
            <form action="{{Route('register')}}" method="post">
              ...
              <button type="submit" class="themeht-btn">Register</button>
            </form>
            <span class="mb-0 mt-4 text-capitalize text-black d-inline-block">Sudah punya akun ? <a class="text-decoration-underline" href="register.html">
                <i>Login</i>
              </a>
            </span>
